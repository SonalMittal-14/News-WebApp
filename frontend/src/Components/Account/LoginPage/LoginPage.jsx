  ...
  return (
    <>
      <div className="flex justify-center min-h-screen relative">
        ...
        <div className="items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] glassmorphism-form absolute font-[sans-serif] text-gray-800 bg-white flex items-center mt-36 rounded-xl overflow-hidden">
          <form
